# coding:utf-8
from main_window.config import cfg, HELP_URL, FEEDBACK_URL, AUTHOR, VERSION, YEAR
...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.settingLabel.setStyleSheet("color:black")
